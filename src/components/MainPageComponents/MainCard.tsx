...
export default function MainCard({ realEstates, loading, asSlider }: MainCardProps) {
  ...
  const totalItems = realEstates.length;
  const maxIndex = totalItems - visibleItems; // Maximum index allowed before resetting
  ...
  if (loading) {
    return (
      <div className="w-[1591px] h-[500px] flex items-center justify-center">
        <Loading />
      </div>
    );
  }
      ...
      <div className="relative">
        <div className="relative w-[1591px] overflow-hidden">
          <div 
            ...
            style={{ transform: `translateX(-${currentIndex * (404 )}px)` }} // Adjusted for gap as well
          >
